...
#if !defined(SPHERICALPOLYGON_MAX_VERTS)
#error requires SPHERICALPOLYGON_MAX_VERTS
#endif
#if !defined(SPHERICALPOLYGON_NUM_VERTS)
#error requires SPHERICALPOLYGON_NUM_VERTS
#endif
